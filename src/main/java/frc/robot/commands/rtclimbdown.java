 ...
 * will override.
 */
public class rtclimbdown extends Command {

  RtClimber m_rtclimber;

  /** Creates a new Left Climber. */
  public rtclimbdown(RtClimber rtclimber) {
  ...
  public void initialize() {
    ...
    m_rtclimber.setrtclimberwheel(krtclimberdownSpeed);
  ...
  public void end(boolean interrupted) {
    ...
    m_rtclimber.setrtclimberwheel(0);
