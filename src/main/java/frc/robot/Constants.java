...
public final class Constants {
  ...
  public static class LauncherConstants {
	...
	public static final double kLauncherDelay = .01;
}
...
//Positions of Arm
public static final double FLOOR_POSITION = .18;
public static final double FEED_SHOOTER = .7;
public static final double SCORE_AMP = .5;
